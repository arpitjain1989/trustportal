...
class ParticipantChildExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    private $classid;
    ...
    */
    public function collection()
    {
        ...
        ->select('p.id','p.created_at','c.module_name','p.first_name','p.last_name','p.child_first_name','p.child_last_name','p.age','p.whatsapp_no', 'p.mobile','p.email','p.price','p.payment_status')
        ->get();
